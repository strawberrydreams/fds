...
public interface UserMapper {
    ...
    @Insert("INSERT INTO USERS (ID, USER_ID, NAME, USER_PW, USER_EMAIL, BIRTH, GENDER, ROLE, PW_QUESTION, PW_ANSWER) " +
            "VALUES (SEQ_USERS.NEXTVAL, #{userId}, #{name}, #{userPw}, #{userEmail}, #{birth}, #{gender}, 'USER', #{pwQuestion}, #{pwAnswer})")
